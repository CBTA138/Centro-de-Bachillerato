        ...
        <main>
            ...
            <div class="contenedor__todo">
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="guardar_aviso.php" method="POST" class="formulario__login">
                        <h2>Titulo del Aviso</h2>
                       <input type="text" placeholder="Titulo del Aviso" name="titulo" required>
                       <h2>Descripcion</h2>
                    ...
                    <!--Register-->
                    <form action="guardar_aviso.php" method="POST" class="formulario__register">
                    <h2>Titulo del Aviso</h2>
                       <input type="text" placeholder="Titulo del Aviso" name="titulo" required>
                       <h2>Descripcion</h2>
                       <input type="text" placeholder="Descripcion" name="descripcion" required>
