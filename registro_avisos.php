            ...
            <div class="contenedor__todo">
                <div class="caja__trasera">
                    <div class="caja__trasera-login">
                        <h3>Registro de Avisos</h3>
                        <p>Registrate en la pagina</p>
                        <button id="btn__iniciar-sesion">Avisos</button>
                    </div>
                    <div class="caja__trasera-register">
                        <h3>Registrar tu Aviso</h3>
                        <p>Regístrate en la pagina</p>
                        <button id="btn__registrarse">Avisos</button>
                    </div>
                </div>
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="php/registro_aviso.php" method="POST" class="formulario__login">
                        <h2>Titulo del Aviso</h2>
                       <input type="text" placeholder="Titulo del Aviso" name="titulo">
                       <h2>Descripcion</h2>
                    ...
                    <!--Register-->
                    <form action="php/registro_aviso.php" method="POST" class="formulario__register">
                    <h2>Titulo del Aviso</h2>
                       <input type="text" placeholder="Titulo del Aviso" name="titulo">
                       <h2>Descripcion</h2>
                       <input type="text" placeholder="Descripcion" name="descripcion">
